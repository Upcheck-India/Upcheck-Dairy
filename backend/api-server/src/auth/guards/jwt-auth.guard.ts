import { Injectable, ExecutionContext, Logger, UnauthorizedException, CanActivate, Inject } from "@nestjs/common";
...
export class JwtAuthGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    this.logger.log(`[GUARD] ${method} ${url} — verifying via supabase.auth.getUser()`);
